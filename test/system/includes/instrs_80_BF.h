...
public:
    ...
    void test_0xA8_half();
    void test_0xA8_zero_half();
    void test_0xA9_half();
    void test_0xA9_zero_half();
    void test_0xAA_half();
    void test_0xAA_zero_half();
    void test_0xAB_half();
    void test_0xAB_zero_half();
    void test_0xAC_half();
    void test_0xAC_zero_half();
    void test_0xAD_half();
    void test_0xAD_zero_half();
    void test_0xAE_half();
    void test_0xAE_zero_half();
    void test_0xAF_half();
    void test_0xAF_zero_half();
